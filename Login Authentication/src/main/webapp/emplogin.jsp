...
.circle {
  width: 100px;
  height: 100px;
  background: radial-gradient(#57BEE6,#57BEE6);
  border-radius: 50%;
  position: absolute;
...
<body style="background-image: url('https://i.pinimg.com/originals/92/ab/51/92ab51c947d618aceb76839f1a444394.gif'); background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
...
<section class="header--settings-block snipcss-fpjRB">
  <div class="container header--settings-container">
    ...
    <div class="header--user-block" style="margin-left: auto;">
       <a href="/" class="btn btn--primary hide-on-mob" aria-label="">Back</a>
      <a href="empreg" class="btn btn--primary hide-on-mob" aria-label="Sign up">Sign up</a>
...
<div class="card" >
    ...
    <div class="circle"></div>
    <div class="card-inner" style="background-image: url('https://i.pinimg.com/474x/15/2a/cb/152acb3335a9f8a6813f2017991bfa53.jpg');">
<br>
<h3 align=center style="color:#06142E" ><u>Manager Login</u></h3>
